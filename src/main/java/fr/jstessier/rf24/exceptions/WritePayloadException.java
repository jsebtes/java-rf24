...
/**
 * Exception for payload send.
 * 
 * @author J.S. TESSIER
 */
public class WritePayloadException extends RF24Exception {

	private static final long serialVersionUID = -2212310854913684830L;
